...
fn parse_quoted_string(input: &str) -> IResult<&str, String> {
    delimited(
        char('"'),
        map(many0(parse_escaped_char), |chars| chars.into_iter().collect()),
        char('"'),
    ).parse(input)
}
...
mod tests {
    ...
    fn parse_simple_fn_path() {
        ...
        assert_eq!(
            path.segments,
            vec![Segment::Kind("fn".to_string()), Segment::Name("add".to_string())]
        );
    }
    ...
    fn serialize_simple_name() {
        ...
        assert_eq!(path.to_string(), "fn::add");
    }
    ...
    fn serialize_name_with_spaces() {
        ...
        assert_eq!(path.to_string(), "test::\"add function\"");
    }
    ...
    fn serialize_name_with_double_colons() {
        ...
        assert_eq!(path.to_string(), "fn::\"foo::bar\"");
    }
    ...
    fn serialize_name_with_quote() {
        ...
        assert_eq!(path.to_string(), "test::\"with \\\"quote\\\"\"");
    }
