...
This project designs conventions and tooling for AI-assisted development, so rejecting AIGC within it would be contradictory. However, given the ongoing discussions around AIGC intellectual property, we believe it is necessary to give AIGC due consideration and maintain clear boundaries.
